...
public class Controller {
     ...
     */
    private static final int numberOfDrones = 10;

    /**
     * Nombre de checkpoints à générer au départ
     */
    private static final int numberOfCheckpoints = 100;
     ...
     * Objet graphique
     */
    private static final GraphicsInterface graphics = new LocalGraphics(800, 800);
