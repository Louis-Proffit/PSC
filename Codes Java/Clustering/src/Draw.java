...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private void init() {
        ...
        frame = new JFrame();
        // Ligne rajoutée pour être en echelle pleine
     ...
     * ..., (<em>x</em><sub><em>n</em>â€“1</sub>,
     * <em>y</em><sub><em>n</em>â€“1</sub>).
     *
    ...
    private static Image getImage(String filename) {
        ...
        /*
         * if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
         * URL url = StdDraw.class.getResource(filename); if (url != null) icon = new
         * ImageIcon(url); }
         */
